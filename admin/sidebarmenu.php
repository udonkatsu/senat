                ...
                <ul class="nav side-menu">
                    <li><a><i class="fa fa-file-text"></i> Pengurus Harian <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="pengurus/notulensi.php"><i class="fa  fa-inbox"></i>Notulensi</a></li>
                            <li><a href="pengurus/proposal.php"><i class="fa fa-inbox"></i>Proposal</a></li>
                            <li><a href="pengurus/laporanpj.php"><i class="fa fa-inbox"></i>Laporan Pertanggung
                                    Jawaban</a>
                            </li>
                            <li><a href="pengurus/dokumentasi.php"><i class="fa fa-inbox"></i>Dokumentasi</a></li>
                        </ul>
                    </li>
                    <li><a><i class="fa fa-file-text"></i> Komisi A <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="Komisi-a/rencana-kerja-tahunan.php"><i class="fa  fa-inbox"></i>Rencana Kerja
                                    Tahunan</a></li>
                            <li><a href="Komisi-a/format-administrasi.php"><i class="fa  fa-inbox"></i>Format
                                    Administrasi</a></li>
                            <li><a href="Komisi-a/laporan-quartil.php"><i class="fa  fa-inbox"></i>Laporan Quartil</a>
                            </li>
                    ...
                    <li><a><i class="fa fa-file-text"></i> Komisi B <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="komisi-b/undang-undang.php"><i class="fa  fa-inbox"></i>Undang-undang</a></li>
                    ...
                    <li><a><i class="fa fa-file-text"></i> Komisi C <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="komisi-c/musyawarah-mahasiswa.php"><i class="fa  fa-inbox"></i>Musyawarah
                                    Mahasiswa</a></li>
                            <li><a href="komisi-c/penilaian-ukm.php"><i class="fa fa-inbox"></i>Penilaian UKM</a></li>
                            <li><a href="komisi-c/dokumentasi.php"><i class="fa fa-inbox"></i>Dokumentasi</a></li>
                        </ul>
                    </li>
                    <li><a><i class="fa fa-users"></i>Tambah Data<span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="input-dokumen.php"><i class="fa  fa-inbox"></i>Data Dokumen</a></li>
                            <li><a href="data-pengguna.php"><i class="fa  fa-inbox"></i>Data Pengguna</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
