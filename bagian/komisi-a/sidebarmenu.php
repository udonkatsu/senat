            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li><a><i class="fa fa-file-text"></i> Komisi A <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="rencana-kerja-tahunan.php"><i class="fa  fa-inbox"></i>Rencana
                                    Kerja Tahunan</a></li>
                            <li><a href="format-administrasi.php"><i class="fa  fa-inbox"></i>Format
                                    Administrasi</a></li>
                            <li><a href="laporan-quartil.php"><i class="fa  fa-inbox"></i>Laporan
                                    Quartil</a></li>
                            <li><a href="ad-art.php"><i class="fa fa-inbox"></i>AD ART</a></li>
