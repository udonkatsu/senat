                ...
                <div class="bg-gray-900 p-10 flex flex-col w-full shadow-xl rounded-xl">
                    ...
                    <form action="proses_login.php" id="login" name="login" method="post" class="w-full">
                        <div id="input" class="flex flex-col w-full my-5">
                            ...
                            <input type="text" id="username" name="username" placeholder="Please insert your username"
                        ...
                        <div id="button" class="flex flex-col w-full my-5">
                            ...
                            <div class="flex justify-evenly mt-5">
                                <a href="../../admin/login" class="text-center font-medium text-gray-500">Admin? Login
                                    disini!</a>
                            </div>
                        </div>
                    </form>
